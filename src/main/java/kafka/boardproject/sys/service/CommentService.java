...
public class CommentService {
    ...
    public Comment createComment(CommentDto commentDto, HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            Comment comment = new Comment(commentDto, user.getUsername());
    ...
    @Transactional
    public Comment updateComment(int id, CommentDto commentDto, HttpServletRequest request) {
    ...
    @Transactional
    public Comment deleteComment(int id,HttpServletRequest request) {
